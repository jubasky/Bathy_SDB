...
#
# Created: Thu Sep 26 12:27:28 2019
...
class Ui_Main_Window(object):
    def setupUi(self, Main_Window):
        ...
        self.widget_2.setGeometry(QtCore.QRect(10, 10, 211, 221))
        ...
        self.actionExport_Metadata = QtGui.QAction(Main_Window)
        self.actionExport_Metadata.setObjectName(_fromUtf8("actionExport_Metadata"))
        self.actionCorrigir_Metadata = QtGui.QAction(Main_Window)
        self.actionCorrigir_Metadata.setObjectName(_fromUtf8("actionCorrigir_Metadata"))
        self.actionExtrairXYZ = QtGui.QAction(Main_Window)
        self.actionExtrairXYZ.setObjectName(_fromUtf8("actionExtrairXYZ"))
        ...
        self.menuTools.addAction(self.actionExport_Metadata)
        self.menuTools.addAction(self.actionCorrigir_Metadata)
        self.menuTools.addAction(self.actionExtrairXYZ)
    ...
    def retranslateUi(self, Main_Window):
        Main_Window.setWindowTitle(_translate("Main_Window", "Bathy_SDB", None))
        self.pushButton_cancel.setText(_translate("Main_Window", "Cancelar", None))
        self.menuFile.setTitle(_translate("Main_Window", "&Ficheiro", None))
        self.menuView.setTitle(_translate("Main_Window", "&Ver", None))
        self.menuAbout.setTitle(_translate("Main_Window", "&Info", None))
        self.menuDatabase.setTitle(_translate("Main_Window", "&Base de dados", None))
        self.menuTools.setTitle(_translate("Main_Window", "Fe&rramentas", None))
        ...
        self.actionExit.setText(_translate("Main_Window", "&Sair", None))
        ...
        self.actionNew.setText(_translate("Main_Window", "&Nova", None))
        self.actionEdit.setText(_translate("Main_Window", "&Edit", None))
        self.actionConnect.setText(_translate("Main_Window", "&Ligar", None))
        self.action_GeoSearch.setText(_translate("Main_Window", "Pesquisa espacial", None))
        ...
        self.actionConfig.setText(_translate("Main_Window", "&Configuração", None))
        ...
        self.actionExport_Metadata.setText(_translate("Main_Window", "Export Metadata", None))
        self.actionCorrigir_Metadata.setText(_translate("Main_Window", "Corrigir Metadata", None))
        self.actionExtrairXYZ.setText(_translate("Main_Window", "ExtrairXYZ", None))
