...
#
# Created: Mon Jan 09 23:48:20 2017
...
class Ui_FormNewDatabase(object):
    def setupUi(self, FormNewDatabase):
        ...
        FormNewDatabase.resize(500, 500)
        FormNewDatabase.setMinimumSize(QtCore.QSize(500, 500))
        FormNewDatabase.setMaximumSize(QtCore.QSize(500, 500))
        FormNewDatabase.setBaseSize(QtCore.QSize(500, 350))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(20, 20, 461, 281))
        ...
        self.lineEdit_db.setGeometry(QtCore.QRect(310, 20, 141, 25))
        ...
        self.lineEdit_passwd.setGeometry(QtCore.QRect(310, 60, 141, 25))
        ...
        self.label_5.setGeometry(QtCore.QRect(236, 25, 60, 13))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.label_6 = QtGui.QLabel(self.groupBox_2)
        self.label_6.setGeometry(QtCore.QRect(233, 60, 60, 20))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.textEdit = QtGui.QTextEdit(self.groupBox_2)
        self.textEdit.setGeometry(QtCore.QRect(10, 90, 441, 181))
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.pushButtonCriar = QtGui.QPushButton(FormNewDatabase)
        self.pushButtonCriar.setGeometry(QtCore.QRect(400, 460, 91, 31))
        self.pushButtonCriar.setObjectName(_fromUtf8("pushButtonCriar"))
        self.pushButtonSair = QtGui.QPushButton(FormNewDatabase)
        self.pushButtonSair.setGeometry(QtCore.QRect(10, 460, 111, 31))
    ...
    def retranslateUi(self, FormNewDatabase):
        ...
        self.label_5.setText(_translate("FormNewDatabase", "Database", None))
